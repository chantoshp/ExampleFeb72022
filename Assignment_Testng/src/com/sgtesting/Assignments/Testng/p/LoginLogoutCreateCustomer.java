...
public class LoginLogoutCreateCustomer 
{
	...
	@Test(priority = 6,dataProvider = "CreateCustomer")
	private static void AddCustomer(String AddCu)
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.id("customerLightBox_nameField")).sendKeys(AddCu);
			Thread.sleep(1000);
	...
	public Object[][] getaddnewcustomer()
	{
		return new Object[][] {{"Democustomer1"},{"Democustomer2"}};
	}
